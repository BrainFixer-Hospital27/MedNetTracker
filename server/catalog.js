...
const DEVICE_STATUSES = {
  ...
  // Оборудование, которого ещё нет физически. Учитывать его полезно:
  // видно, что закуплено и чего ждать, а инвентарный номер и место
  // назначения можно вписать заранее.
  ordered:     { label: 'Заказано',   color: '#8250df' },
  planned:     { label: 'Планируется', color: '#57606a' },
